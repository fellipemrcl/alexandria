...
public class AuthorController {
  ...
  public ResponseEntity<ResponseDTO<Author>> updateAuthor(@PathVariable Long authorId,
    ...
    if (optionalAuthor.isEmpty()) {
      ResponseDTO<Author> responseDTO = new ResponseDTO<>(
          String.format("Autor com id %d não encontrado!", authorId), null);
      return ResponseEntity.status(HttpStatus.NOT_FOUND).body(responseDTO);
    }

    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Autor atualizado com sucesso!",
        optionalAuthor.get());
  ...
  public ResponseEntity<ResponseDTO<Author>> deleteAuthor(@PathVariable Long authorId) {
    ...
    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Autor removido com sucesso!",
        optionalAuthor.get());
    return ResponseEntity.ok(responseDTO);
  }
  ...
  public List<AuthorDTO> getAllAuthors() {
    List<Author> authors = (List<Author>) authorService.getAllAuthors();
